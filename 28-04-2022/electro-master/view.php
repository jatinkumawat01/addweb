		...
		while($row=$q2->fetch())
            ...
            ?>
                ...
                <div class="col-md-5 col-md-push-2">
                    <div id="product-main-img">
                        <div class="product-preview">
                            <img src="admin_panel/<?php echo $filepath; ?>" alt="" style="height:500px; width:400px;">
                        </div>
                ...
                <div class="col-md-2  col-md-pull-5">
                    <div id="product-imgs">
                        <div class="product-preview">
                            <img src="admin_panel/<?php echo $filepath; ?>" alt="" style="height:140px; width:150px;" >
                        </div>
                                    ...
                                    <div class="product">
                                        <div class="product-img">
                                            <a href="view.php?tname=<?php echo $tname;?>&id=<?php echo $id;?>"><img
                                                    src="admin_panel/<?php echo $filepath; ?>" style="height:270px; width:270px; padding: 20px 20px 20px 20px; "alt=""></a>
