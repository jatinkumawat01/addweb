							...
							<div>
								<a href="wishlist.php">
									...
									try {
										...
										$SQL1 = "select sum(Quantity) as Wsum from wishList where UserMail='$email'";
										$q1 = $pdo->query($SQL1);
										$q1->setFetchMode(PDO::FETCH_ASSOC);
										while ($row1 = $q1->fetch()) {
											$Wsum = $row1['Wsum'];
							...
							<div class="dropdown">
								<a href="Addtocart.php">
									...
									try {
										...
										$SQL1 = "select sum(Quantity) as Qsum from AddToCart where UserMail='$email'";
										$q1 = $pdo->query($SQL1);
										$q1->setFetchMode(PDO::FETCH_ASSOC);
										while ($row1 = $q1->fetch()) {
											$Qsum = $row1['Qsum'];
			...
			<ul class="main-nav nav navbar-nav">
				...
				try {
					...
					while ($row = $q1->fetch()) {
						...
						$tname2 = $row['category_tname'];
				?>
						<li><a href="productView.php?tname=<?php echo $tname2; ?>">
