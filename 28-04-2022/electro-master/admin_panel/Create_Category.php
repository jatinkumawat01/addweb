...
if($query) 
{
    $sql1="CREATE TABLE $tname1 (email varchar(100) NOTNULL, ImgId int(11) NOT NULL  PRIMARY KEY AUTO_INCREMENT,img_path varchar(200) NOT NULL,`name` text NOT NULL,brand text NOT NULL,size text NOT NULL, color text NOT NULL, detail text NOT NULL, price double(12,2) NOT NULL, isActive int(11) NOT NULL) ";
    echo $sql1;
