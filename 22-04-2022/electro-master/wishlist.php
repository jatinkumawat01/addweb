...
include("db.php"); ?>
	<body>
		...
		<div class="section">
			...
			<center>	<h1>WishList Page</h1> </center>
							<tbody>
						...
						try {
						   ...
						   while($row=$q->fetch())
                            ...
                            ?>
                                ...
                                <a  href='view.php?id=<?php echo $row["ProductId"]; ?>&tname=<?php echo $row["ProductName"] ?>' ><img src=admin_panel/<?php echo $row['img_path'];?> height=100 width=100 /></a>
                </td>
