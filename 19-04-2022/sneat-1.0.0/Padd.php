                  ...
                  <div class="card mb-4">
                    ...
                    <div class="card-body">
                      <form enctype="multipart/form-data" method ='post'>
                        <div class="row mb-3">
                          <label class="col-sm-2 col-form-label" for="basic-default-name"><?php echo $tname5; ?> Product Id</label>
                          <div class="col-sm-10">
...
$sql = "INSERT into $tname5 (ImgId,img_path,name,brand,size,color,detail,price ,isActive) VALUES ($id,'$filepath','$name','$brand' ,'$size','$color','$detail',$price,1)";
