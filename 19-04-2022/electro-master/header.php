			...
			<div id="top-header">
				<div class="container">
					...
					<ul class="header-links pull-right">
						...
						{
						?>
						<li><a href="signup.php"><i class="fa fa-sign-out" aria-hidden="true"></i>Signup</a></li>
						<?php
						...
						?>
						<li><a href="index12.php"><i class="fa fa-sign-out" aria-hidden="true"></i>Logout</a></li>
						<?php }?>
					</ul>
				</div>
			</div>
			...
			<div class="container">
				...
				<div id="responsive-nav">
					...
					<ul class="main-nav nav navbar-nav">
						<li class=""><a href="index12.php">Home</a></li>
						<?php
						try {
											...
											while($row=$q1->fetch())
												{
													...
													$tname2=$row['category_tname'];
													?>
						<li><a href="productView.php?tname=<?php echo $tname2;?>"><?php echo $c_name;?></a></li>
						<?php }
										}
