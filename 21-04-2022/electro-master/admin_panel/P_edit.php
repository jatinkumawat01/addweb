                ...
                <div class="col-xxl">
                  <div class="card mb-4">
                    <div class="card-header d-flex align-items-center justify-content-between">
                      <h5 class="mb-0">Product Edit form</h5>
...
$sql="update $tname6 set img_path ='$file', detail='$detail', price=$price ,color='$color', brand='$brand' , size='$size' , name='$name' where ImgId=$Id";
