                ...
                <div id="myCarousel" class="carousel slide" data-ride="carousel">
                    ...
                    <div class="carousel-inner">
                        <div class="item active">
                            <img src="img/slider1.png" alt="Los Angeles" style=" width: 1182px; height: 200px;">
                        </div>

                        <div class="item">
                            <img src="img/slider2.png" alt="Chicago" style=" width: 1182px; height: 200px;">
                        </div>

                        <div class="item">
                            <img src="img/slider3.png" alt="New York" style=" width: 1182px; height: 200px;">
                        </div>
                    </div>
		...
		{ 
			...
			$price=$row["price"];
                                ...
                                <div class="col-md-3 col-xs-8">
                                    <div class="product">
                                        <div class="product-img">
                                            <a href="view.php?tname=<?php echo $tname4;?>&id=<?php echo $id;?>"><img
                                        ...
                                        <div class="product-body">
                                            ...
                                            <h3 class="product-name"><a
                                                    href="view.php?tname=<?php echo $tname4;?>&id=<?php echo $id;?>"><?php echo $name; ?></a>
                                            </h3>
                                            ...
                                            <div class="product-btns">
                                                <a
                                                    href="wish.php?tname=<?php echo $tname4;?>&id=<?php echo $id;?>&email=<?php echo $email;?>"><i
