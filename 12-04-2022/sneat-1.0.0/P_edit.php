...
$sql="update $tname set ImgId=$id,img_path ='$file', detail='$detail', price=$price ,color='$color', brand='$brand' , size='$size' , name='$name' where ImgId=$Id";
