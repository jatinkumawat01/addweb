            ...
            <div class="col-6 d-lg-flex d-none h-100 my-auto pe-0 position-absolute top-0 start-0 text-center justify-content-center flex-column">
              <div class="card card-plain">
                <div class="card-header">
                  <h4 class="font-weight-bolder">Decoration Edit page</h4>
...
$filepath = "images/decor/" . $_FILES["file"]["name"];
$details=$_POST['details'];
$prize=$_POST['prize'];
$title=$_POST['title'];
$highlights=$_POST['ighlights'];
$Id=$_REQUEST['Id'];
echo "ImgId=$id, img_path ='$filepath', details='$details', prize=$prize , title='$title', Highlights='$highlights' where ImgId=$Id";
$sql = "update decor set ImgId=$id, img_path ='$filepath', details='$details', prize=$prize , title='$title', Highlights='$highlights' where ImgId=$Id";
