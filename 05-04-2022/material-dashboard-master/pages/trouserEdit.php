            ...
            <div class="col-6 d-lg-flex d-none h-100 my-auto pe-0 position-absolute top-0 start-0 text-center justify-content-center flex-column">
              <div class="card card-plain">
                <div class="card-header">
                  <h4 class="font-weight-bolder">Trouser Edit page</h4>
...
$filepath = "images/touser/" . $_FILES["file"]["name"];
...
$sql = "update trouser set ImgId=$id,img_path ='$filepath', details='$details',prize=$prize, title='$title', Highlights='$highlights' where ImgId=$Id";
