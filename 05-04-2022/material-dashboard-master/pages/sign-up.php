                ...
                <div class="card-body">
                  <form name="myform" mathod='post'>
                    ...
                    <div class="input-group input-group-outline mb-3">
                      ...
                      <input type="int" class="form-control" name='mobile' id='mobile'>
                    </div>
                    <div class="input-group input-group-outline mb-3">
                    ...
                    <div class="text-center">
                      <button type="submit" class="btn btn-lg bg-gradient-primary btn-lg w-100 mt-4 mb-0" name='signup' value='Sign Up'  formmethod="post">Sign Up</button>
                    </div>
                  </form>
                </div>
