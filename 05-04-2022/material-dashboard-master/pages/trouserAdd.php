            ...
            <div class="col-6 d-lg-flex d-none h-100 my-auto pe-0 position-absolute top-0 start-0 text-center justify-content-center flex-column">
              <div class="card card-plain">
                <div class="card-header">
                  <h4 class="font-weight-bolder">Trouser Add page</h4>
...
$filepath = "images/trouser/" . $_FILES["file"]["name"];
$details=$_POST['details'];
$prize=$_POST['prize'];
$title=$_POST['title'];
$highlights=$_POST['Hightlights'];


$sql = "INSERT into trouser (ImgId,img_path,details,prize,title,Highlights) VALUES ($id,'$filepath','$details',$prize ,'$title','$highlights')";
